<form action="<?php echo wp_login_url(); ?>" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;" method="post">
        ...
        <div class="u-form-checkbox u-form-group">
          ...
          <label for="checkbox-a30d" class="u-block-89aa-32 u-field-label" style="" name=""><?php _e( 'Remember Me' ); ?></label>
        </div>
